...
public class TopActivityTest {
    ...
    @Test
    public void 正常系_1_1_1_書き込み許諾許諾ダイアログを表示すること() {
        String actual = "";
        String expected = "";
    ...
    @Test
    public void 異常系_1_1_2_アプリキルすること() {
        String actual = "";
        String expected = "";
        assertThat(actual, is(expected));
    }
    ...
    @Test
    public void 正常系_1_1_3_読み込み許諾許諾ダイアログを表示すること() {
        String actual = "";
        String expected = "";
        assertThat(actual, is(expected));
    }
    ...
    @Test
    public void 異常系_1_1_4_アプリキルすること() {
        String actual = "";
        String expected = "";
        assertThat(actual, is(expected));
    }
    ...
    @Test
    public void 正常系_1_1_5_許諾ダイアログを表示すること() {
        String actual = "";
        String expected = "";
        assertThat(actual, is(expected));
    }
    ...
    @Test
    public void 異常系_1_1_6_NGアプリキルすること() {
        String actual = "";
        String expected = "";
        assertThat(actual, is(expected));
    }
